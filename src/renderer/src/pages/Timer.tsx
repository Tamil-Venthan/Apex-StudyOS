...
import { Play, Pause, RotateCcw, SkipForward, Settings, Maximize2, Minimize2, Plus } from 'lucide-react'
...
import ManualFocusEntry from '@renderer/components/Timer/ManualFocusEntry'
...
export default function Timer(): React.JSX.Element {
  ...
  return (
    <div className="space-y-6 relative">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-gradient-to-r from-blue-500/20 to-purple-500/20 hover:from-blue-500/30 hover:to-purple-500/30 border border-blue-500/30 rounded-lg transition-all hover:scale-105 text-sm font-medium text-blue-400"
              title="Add Focus Time Manually"
            >
        ...
        <div className={`max-w-2xl mx-auto space-y-8 ${isFullscreen ? 'scale-125' : ''}`}>
          ...
          <div className="flex gap-2 justify-center">
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-all ${mode === 'focus'
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-all ${mode === 'shortBreak'
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-all ${mode === 'longBreak'
          ...
          <div className="text-center">
            ...
            <div className="flex gap-1 justify-center mt-2">
              {[...Array(4)].map((_, i) => (
                <div
                  key={i}
                  className={`w-2 h-2 rounded-full ${i < sessions.length % 4 ? 'bg-primary' : 'bg-white/10'
                    }`}
                />
              ))}
            </div>
      ...
      <ManualFocusEntry open={showManualEntry} onClose={() => setShowManualEntry(false)} />
    </div>
  )
}
